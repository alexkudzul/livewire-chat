                ...
                <div class="h-[calc(100vh-10.5rem)] overflow-auto border-t border-gray-200">
                        ...
                        <div class="px-4 py-3">
                            ...
                            <ul class="space-y-4">
                                @forelse ($this->contacts as $contact)
                                    <li wire:click="openChatContact({{ $contact }})" class="cursor-pointer">
                                        <div class="flex">
                    ...
                    @else
                        @foreach ($this->chats as $chatItem)
                            <div wire:key="chats-{{ $chatItem->id }}" wire:click="openChatExisting({{ $chatItem }})"
            ...
            <div class="col-span-2">
                ...
                @else
                    <div class="w-full h-full flex justify-center items-center">
                        <div>
                            {{-- WhatsApp Image --}}
                            <div class="_3SOOk" style="opacity: 1;">
                                <span data-icon="intro-md-beta-logo-light" class="_3PwsU">
                            ...
                            <h1 class="text-center text-gray-500 text-4xl mt-8">WhatsApp Web</h1>
                        </div>
                    </div>
                @endif
            </div>
